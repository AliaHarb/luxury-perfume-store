...
export default function App() {
  ...
  // 1. جلب المنتجات فوراً وبشكل لحظي عبر الـ Modular SDK
  useEffect(() => {
    ...
    setCart((prev) => {
      ...
      return [
        ...prev,
        {
          ...
          price: Number(safeSize.price) || Number(product.price) || 0,
          qty: 1,
        },
      ];
    });
  ...
  const handleConfirmOrder = async (form) => {
    ...
    try {
      ...
      // تخزين الطلب مباشر في Firestore
